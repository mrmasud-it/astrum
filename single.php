					...
					<section class="post-content">
						...
						<header class="meta">
							...
							<ul>
								...
								<li><a href="#"><?php echo get_the_category_list($post_id) ?></a></li>
...
================================================== -->
		<div class="four columns">
			...
			<!-- About -->
			<div class="widget">
				<h3 class="headline">About</h3><span class="line"></span>
				<div class="clearfix"></div>
			...
			<div class="widget" style="margin: 13px 0 0 0;">
				<h3 class="headline">Tags</h3><span class="line"></span>
				<div class="clearfix"></div>
			...
			<!-- Archives -->
			<div class="widget">
				<h3 class="headline">Archives</h3><span class="line"></span>
				<div class="clearfix"></div>
				<nav class="categories">
					<ul>
